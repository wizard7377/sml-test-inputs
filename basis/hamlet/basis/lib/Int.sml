...
struct
  ...
  val precision      = Int.precision  () : int option
  val minInt         = Int.minInt  () : int option
  val maxInt         = Int.maxInt  () : int option
  ...
  val op quot        = Int.quot  : int * int -> int
  val op rem         = Int.rem  : int * int -> int
