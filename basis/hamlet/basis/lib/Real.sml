...
(* Not supported by all implementations:
  val radix                   = Real.radix  () : int
  val precision               = Real.precision  () : int

  val maxFinite               = Real.maxFinite  () : real
  val minPos                  = Real.minPos  () : real
  val minNormalPos            = Real.minNormalPos  () : real
*)
  val posInf                  = 1.0/0.0
  val negInf                  = ~1.0/0.0
  ...
  val fromInt                 = Real.fromInt  : Int.int -> real
  val floor                   = Real.floor    : real -> Int.int
  val ceil                    = Real.ceil     : real -> Int.int
  val trunc                   = Real.trunc    : real -> Int.int
  val round                   = Real.round    : real -> Int.int
(* Not supported by all implementations:
  val realFloor               = Real.realFloor  : real -> real
  val realCeil                = Real.realCeil   : real -> real
  val realTrunc               = Real.realTrunc  : real -> real
  val realRound               = Real.realRound  : real -> real
*)
...
*)
  ...
  val op/                     = op/ : real * real -> real
(* Not supported by all implementations:
  val rem                     = Real.rem  : real * real -> real
*)
  fun *+(x, y, z)             = x*y + z
  fun *-(x, y, z)             = x*y - z
  ...
  val isFinite                = Real.isFinite    : real -> bool
  val isNan                   = Real.isNan       : real -> bool
(* Not supported by all implementations:
  val isNormal                = Real.isNormal    : real -> bool
*)
  val signBit                 = Real.signBit     : real -> bool
  val checkFloat              = Real.checkFloat  : real -> real
  val copySign                = Real.copySign    : real * real -> real
(* Not supported by all implementations:
  val nextAfter               = Real.nextAfter   : real * real -> real
*)
...
*)
  ...
  val toString   = Real.toString  : real -> string
