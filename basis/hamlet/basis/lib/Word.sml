...
struct
  ...
  val wordSize     = Word.wordSize  () : int

  fun toLarge w    = w
  fun toLargeX w   = w
  fun fromLarge w  = w
  val toInt        = Word.toInt  : word -> Int.int
  val toIntX       = Word.toIntX  : word -> Int.int
  val fromInt      = Word.fromInt  : Int.int -> word
  ...
  val notb   = Word.notb  : word -> word
  val orb    = Word.orb   : word * word -> word
  val xorb   = Word.xorb  : word * word -> word
  val andb   = Word.andb  : word * word -> word
